...
Begin dlgBase dlgAbout
   ...
   Begin WebRectangle rctFormContent
      ...
      Begin WebLink labPlugin
         ...
         Top             =   268
         Underline       =   False
         URL             =   "#constUrl_CubeSQLPlugin"
         Visible         =   True
         Width           =   266
         _mPanelIndex    =   -1
      End
      Begin WebLink labXojo
         Appearance      =   0
         Bold            =   False
         ControlID       =   ""
         Enabled         =   True
...
#tag Events labVersion
	#tag Event
		Sub Opening()
		  ...
		  Me.Text = appVersion + appStageCode
